...
import {Volume2, VolumeX, Play, Pause, Rewind, FastForward, Loader2, SkipBack, SkipForward} from "lucide-react";
...
function CustomAudioPlayer({
    ...
    // Keep track of whether audio metadata was loaded
    ...
    useEffect(() => {
        ...
        // Do not automatically try to play when source changes
    }, [src]);
    ...
    //changing time from seconds to MM:SS format
    ...
    const handlePlay = () => {
        ...
        if (songId) {
            addToRecentlyPlayed(songId).then(() => console.log("Added to recently played"))
                .catch(error => console.error("Failed to add to recently played:", error));
        }
        ...
        <div className="custom-audio-player">
            ...
            <div className="progress-container">
                ...
                <div className="time-display">
                    ...
                    <span className="duration">{isLoading ? "--:--" : formatTime(duration)}</span>
                </div>
            </div>
            ...
            <div className="controls-container">
                ...
                <div className="playback-controls">
                    ...
                    >
                        {isLoading && !metadataLoaded ? <Loader2 size={30} className="icon-spin"/> : isPlaying ?
                            <Pause size={30}/> :
                            <Play size={30}/>}
                    </button>
                    <button
            ...
            {(isLoading && !metadataLoaded) || isBuffering ? (
                <div className="status-indicators">
                    {isLoading && !metadataLoaded && (
                        <div className="loading-indicator"><Loader2 size={16} className="icon-spin"/> Loading...</div>
                    )}
                    {isBuffering && (
                        <div className="buffering-indicator"><Loader2 size={16} className="icon-spin"/> Buffering....
                        </div>
                    )}
                </div>
            ) : null}
