                  ...
                  {requests && requests.length > 0
                    ? requests.map((request) => (
                        <div key={request.id} className="table-row">
                          ...
                          <div className="cell">
                            <span
                              className={`role-badge ${request.current_role}`}
                            >
                          ...
                          <div className="cell">
                            <span
                              className={`role-badge ${request.requested_role}`}
                            >
                      ...
                      <div className="user-info-section">
                        ...
                        <div className="user-details">
                          ...
                          <p>
                            ...
                            <span
                              className={`role-badge ${selectedRequest.current_role}`}
                            >
                          ...
                          <p>
                            ...
                            <span
                              className={`role-badge ${selectedRequest.requested_role}`}
                            >
                      ...
                      <div className="request-info-section">
                        ...
                        <div className="request-meta">
                          <p>
                            ...
                            <span
                              className={`status-badge ${getStatusColor(selectedRequest.status)}`}
                            >
