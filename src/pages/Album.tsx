    ...
    useEffect(() => {
        ...
        const fetchAlbum = async () => {
            try {
                ...
                const foundAlbum = albums.find((album: Album) => album.id === parseInt(albumId));
                    ...
                    <div className="album-page">
                        <div className="album-header">
                            ...
                            <div className="album-info">
                                ...
                                <p className="album-artist" onClick={handleArtistClick} style={{cursor: 'pointer'}}>
                                    {album.artist_name}
                                </p>
                        ...
                        <div className="album-songs">
                            ...
                            <div className="songs-list">
                                {album.songs.map((song, index) => (
                                    <div key={song.id} className="song-item" onClick={() => handleSongClick(song.id)}>
